...
public interface StoreManager {
    ...
    /**
     * Get the user manager for the given repository id.
     * 
     * @param repositoryId
     *            repository id of object
     * @return the user manager used to authenticate incoming user.
     */
    IUserManager getUserManager(String repositoryId);
    
    /**
     * Set the user manager for the given repository id.
     * 
     * @param repositoryId
     *            repository id of object
     * @param userManager
	 *			  user manager used to authenticate incoming user.
     */
    void setUserManager(String repositoryId, IUserManager userManager);
     ...
     *            id of repository
     * @param repositoryFilePath
     *            file path for persistence manager
