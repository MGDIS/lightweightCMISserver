    ...
    public void testBulkUpdateProperties() {
        ...
        try {
            ...
            for (int i = 0; i < newObjs.size(); i++) {
                ...
                assertTrue(objs.get(i).getChangeToken().compareTo(newObjs.get(i).getChangeToken()) <= 0);
            }
    ...
    public static class ObjectTestTypeSystemCreator implements TypeCreator {
        ...
        private static TypeDefinition createDocumentTypeWithDefault() throws InstantiationException,
            ...
            List<String> defValS = new ArrayList<String>() {
                 ...
                 * 
                 */
                private static final long serialVersionUID = 6121872150287262863L;
            ...
            List<BigInteger> defVal = new ArrayList<BigInteger>() {
                 ...
                 * 
                 */
                private static final long serialVersionUID = 2817351576747453083L;
            ...
            List<BigInteger> defVal2 = new ArrayList<BigInteger>() {
                 ...
                 * 
                 */
                private static final long serialVersionUID = 2411877058221201346L;
        ...
        private static TypeDefinition createFolderTypeWithDefault() throws InstantiationException,
            ...
            List<String> defValS = new ArrayList<String>() {
                 ...
                 * 
                 */
                private static final long serialVersionUID = -5247178961762017285L;
            ...
            List<BigInteger> defVal = new ArrayList<BigInteger>() {
                 ...
                 * 
                 */
                private static final long serialVersionUID = 2535514866572188074L;
            ...
            List<BigInteger> defVal2 = new ArrayList<BigInteger>() {
                 ...
                 * 
                 */
                private static final long serialVersionUID = -4620805297781915665L;
